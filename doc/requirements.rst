...
This is the software requirements file for scikit-surgery-evaluation, part of the
SNAPPY project. The requirements listed below should define
what scikit-surgery-evaluation does. Each requirement can be matched to a unit test that
